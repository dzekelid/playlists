...
swagger: "2.0"
info:
  title: Spotify Browse Featured Playlists
...
paths:
  /browse/featured-playlists:
    get:
      ...
      - in: query
        name: timestamp
        description: A timestamp in ISO 8601 format (yyyy-MM-dd'T'HH:mm:ss) with the
          user's local time to get results tailored to a specific date and time in
          the day
      responses:
        200:
          description: OK
